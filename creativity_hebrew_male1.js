...
API.addStimulusSets({
    ...
    API.addTrialSet('scripts', [
        ...
        {inherit: 'stimulus_trial', data: {text: 'אני בורח מחבורה של בחורים יהודים רודפים אחרי ברחוב ', sid: 2}},
        {inherit: 'stimulus_trial', data: {text: 'אני יושב באוטובוס ורואה שמכניסים מכות לנהג האוטובוס ערבי', sid: 3}},
        {inherit: 'stimulus_trial', data: {text: 'כמה בחורים יהודים  מכניסים לי מכות ומסביב מוחאים כפיים ', sid: 4}},
        {inherit: 'stimulus_trial', data: {text: 'אני מגלה על דלת הדירה שלי כתובת: מוות לערבים', sid: 5}},
