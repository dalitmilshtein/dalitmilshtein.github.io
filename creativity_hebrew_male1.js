  ...
  API.addSettings('logger', {
    ...
    API.addTrialSet('scripts', [
        ...
        {inherit: 'stimulus_trial', data: {text: 'כמה ערבי שיהודים  מכניסים לו מכות ומסביב מוחאים כפיים ', sid: 4}},
	...
	{inherit: 'stimulus_trial', data: {text: 'בכניסה לשדה התעופה מבקשים שאצא  מהאוטו כי אני ערבי  ', sid:9}},
        ...
        {inherit: 'stimulus_trial', data: {text: 'ההורים ערבים שהתחזקו בדת ודורשים שאלך כול שבוע למסגד', sid: 20}},
