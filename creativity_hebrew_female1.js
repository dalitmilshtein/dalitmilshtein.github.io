  ...
  API.addSettings('logger', {
   ...
   API.addStimulusSets({ 
        defaultStim : [{css:{color:'black', 'font-size':'20px'}}],
	...
	Q5         : [{inherit:'defaultStim', media: 'סמן עד כמה המצב רלוונטי לסטודנטים יהודים וערבים בישראל מ-1 רלוונטי ערבים בלבד עד 9 רוונטי ליהודים בלבד'}], 
