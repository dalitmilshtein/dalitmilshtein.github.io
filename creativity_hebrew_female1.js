  ...
  API.addSettings('logger', {
	...
	Q5         : [{inherit:'defaultStim', media: 'סמני כמה המצב המתואר במשפט קשור לפחדים שלך מ-1 קשור מאוד עד 9 לא קשור כלל'}], 
        Q6         : [{inherit:'defaultStim', media: 'סמני עד כמה המצב המתואר במשפט רלוונטי לחיים של סטודנטים יהודים וערבים בישראל מ-1 רלוונטי לסטונטים ערבים בלבד עד 9 רוונטי לסטודנטים יהודים בלבד '}]  
