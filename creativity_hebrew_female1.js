  ...
  API.addSettings('logger', {
	...
	{inherit: 'stimulus_trial', data: {text: 'אני מחכה עם אבא בבית חולים כדי שיקבל כימותרפיה', sid: 70}},
        {inherit: 'stimulus_trial', data: {text: 'אני מסתכל בטלפון בנהיגה ומאבד שליטה ואמא נפצעת קשה', sid: 71}},
        {inherit: 'stimulus_trial', data: {text: 'אני נותן ביס בכריך ומגלה שיש לי מקק בפה', sid: 72}},
        {inherit: 'stimulus_trial', data: {text: 'אני מאבד שליטה ומכניס מכות רצח לילד קטן מאוד', sid: 73}},
	...
	{inherit: 'stimulus_trial', data: {text: ' אני מגלה  שבחורה שאני מאוהב בה וחבר שלי מתחתנים', sid: 82}},
        ...
        {inherit: 'stimulus_trial', data: {text: 'אני נועל זוג נעלי התעמלות לבנות ומכפתר חמישה כפתורים ', sid: 95}},
