  ...
  API.addSettings('logger', {
   ...
   API.addStimulusSets({ 
	...
	Q5         : [{inherit:'defaultStim', media: 'סמן עד כמה המצב המתואר במשפט רלוונטי לחיים של סטודנטים יהודים וערבים בישראל מ-1 רלוונטי לסטונטים ערבים בלבד עד 9 רוונטי לסטודנטים יהודים בלבד'}], 
